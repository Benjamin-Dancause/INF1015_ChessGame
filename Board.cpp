...
Board::Board(QObject *parent) : QGraphicsScene(parent)
{
    ...
    for (int i = 0; i < 8; i++)
    {
        ...
        pieces.append(pawn);
        addItem(pawn);
        LogicalBoard::getBoard().position[i][1] = PAWN;
    }
    ...
    for (int i = 0; i < 8; i++)
    {
        ...
        pieces.append(pawn);
        addItem(pawn);
        LogicalBoard::getBoard().position[i][6] = PAWN;
    }
...

    {
        ...
        addItem(whiteQueen);
        LogicalBoard::getBoard().position[3][7] = QUEEN;

        Queen* blackQueen = new Queen(tile_size * 3 + 7, 7, BLACK);
        pieces.append(blackQueen);
        addItem(blackQueen);
        LogicalBoard::getBoard().position[3][0] = QUEEN;
    }
    
    {
        ...
        addItem(whiteKing);
        LogicalBoard::getBoard().position[4][7] = KING;

        King* blackKing = new King(tile_size * 4 + 7, 7, BLACK);
        pieces.append(blackKing);
        addItem(blackKing);
        LogicalBoard::getBoard().position[4][0] = KING;
    }
